"""
Django settings for proampdna project.
...
SECRET_KEY = '=b+pl($c@lx9we!_)df0#=zsln#-p^64cuxz-3zc)na()ursj_'
...
WSGI_APPLICATION = 'proampdna.wsgi.application'
